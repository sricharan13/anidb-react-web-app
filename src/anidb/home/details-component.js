...
import {createReviewThunk, deleteReviewThunk, findReviewsByAnimeThunk} from "../reviews/reviews-thunks";
                                    ...
                                    <Carousel responsive={responsive} autoPlay={true} infinite={true}>{
                                        details.characters.map((character) => (
                                            <div style={{width: "10rem"}} >
                                                <div className={"text-center"}>
                                                    <img alt="featured character" src={`${character.image}`} height={200} width={128} className="rounded"/>
                                    ...
                                    <Carousel responsive={responsive} autoPlay={true} infinite={true}>{
                                        details.recommendations.map((recommendation) => (
                                            <Link to={`/anime/${recommendation.id}`} className="text-decoration-none text-dark">
                                                <div style={{width: "10rem"}} >
                                                    <div className={"text-center"}>
                                                        <img alt="recommendation" src={`${recommendation.image}`} height={200} width={128} className="rounded"/>
